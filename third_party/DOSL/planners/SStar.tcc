...
SStar::Algorithm<AlgDerived,NodeType,CostType>::Algorithm (freeNav::IS_OCCUPIED_FUNC<2> is_occupied, AlgDerived* shared_instance_p) : _this (static_cast<AlgDerived*>(this))
{ 
