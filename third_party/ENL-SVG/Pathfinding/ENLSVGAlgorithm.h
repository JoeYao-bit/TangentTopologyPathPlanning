...
namespace ENLSVG {
    ...
    // https://github.com/Ohohcakester/ENLSVG-Pathfinding
    class Algorithm {
    ...
    public:
        ...
        Path computePath(Memory& memory, const int sx, const int sy, const int ex, const int ey,
                         double& initial_time, double& search_graph_time,
                         ParentPtrs* parentPtrs = nullptr) const;
